...
TRANS_CONTROLLER = dict(
    NAME = 'randSpatialTransform',
    PARAS = dict(
        paras={
            'offset_x_range': (-0.1, 0.1),
            'offset_y_range': (-0.1, 0.1),
...
DATASET = dict(
    TRAIN_SET = dict(
        ...
        paras = dict(
            ...
            scops_mask_file = '/data/shilong/data/imm/celeba/scops_mask',
        ),
...
metriclist_train = [
    ...
    },
    {
        'name': 'ColorFeatLoss',
        'paras': {
            'item_map': dict(pred='output.color_feat'),
        },
        'weight': 1.0
    },
]
