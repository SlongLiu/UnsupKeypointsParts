...
DATASET = dict(
    TRAIN_SET = dict(
        ...
        dataset = 'wildceleba',
        paras = dict(
            root_dir = '/data/shilong/data/AFLW/aflw_sl/Image' ,
            select_path = '/data/shilong/data/AFLW/aflw_sl/split/train.txt', # training
            anno_path = '/data/shilong/data/AFLW/aflw_sl/anno/anno.txt',
    ...
    TEST_SET = dict(
        ...
        paras = dict(
            root_dir = '/data/shilong/data/AFLW/aflw_sl/Image' ,
            select_path = '/data/shilong/data/AFLW/aflw_sl/split/test.txt', # training
            anno_path = '/data/shilong/data/AFLW/aflw_sl/anno/anno.txt',
