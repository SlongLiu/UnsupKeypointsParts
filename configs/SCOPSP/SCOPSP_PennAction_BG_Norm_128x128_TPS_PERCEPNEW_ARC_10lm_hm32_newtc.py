...
select_class = ['tennis_serve', 'tennis_forehand', 'baseball_pitch','baseball_swing', 'jumping_jacks', 'golf_swing'][-2]
...
DATASET = dict(
    TRAIN_SET = dict(
        ...
        dataset = 'penaction',
        paras = dict(
            root_dir = '/data/shilong/data/penn_action/Penn_Action_CropNoScale' ,
            frames_each_video = None, # training
            split = 'train',
